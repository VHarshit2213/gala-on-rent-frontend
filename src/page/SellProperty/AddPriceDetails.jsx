...
const AddPriceDetails = ({ activeTab, setActiveTab }) => {
    return (
        <div className='p-15 flex flex-col gap-10'>
            <h1 className='text-3xl font-bold'>{"<"} Add Price Details</h1>
            ...
            <ThemeButton title={'Post Property'} className={"!max-w-full !justify-center"} titleClass="!capitalize"  onClick={() => setActiveTab(activeTab + 1)} />
        </div>
    )
}
