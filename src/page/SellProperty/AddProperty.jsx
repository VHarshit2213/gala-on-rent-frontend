...
const AddProperty = () => {
  ...
  return (
    <div className="h-[calc(100vh-70px)] overflow-y-auto">
      <div className="p-4 sm:p-8 lg:p-15 flex justify-center">
        <div className="flex flex-col justify-center border border-gray rounded-lg w-full h-full">
          <div className="bg-orange-transparent p-3 px-6 lg:px-10 l:px-20 flex justify-around items-center gap-4 xsm:gap-6 sm:gap-10 lg:gap-15 w-full overflow-x-auto scrollbar-hide">
            {(navTab || [])?.map((item, index) => (
              <div
                className="flex items-center gap-4 xsm:gap-6 sm:gap-10 lg:gap-15"
              ...
              >
                ...
                >
                  ...
                  <div className="flex flex-col justify-center items-center gap-y-0.5">
                    <span className="text-sm md:text-base whitespace-nowrap">{item}</span>
                    {index < activeTab ? (
