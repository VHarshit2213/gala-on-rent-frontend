...
import { fetchPropertyByCity } from "../../reducer/properties/thunk";
...
const SearchProperty = () => {
  ...
  useEffect(() => {
    if (city && area) {
      dispatch(fetchPropertyByCity({ city, area }));
    }
  }, [city, area, dispatch]);
  ...
  return (
    <div>
      <div className="my-40">
        <div
          className={`bg-white shadow-[0px_1px_8px_0px_#0000001A] w-full fixed flex flex-wrap whitespace-nowrap gap-2 ${
          ...
          <div className="flex flex-col gap-8 mb-6">
            <div className="flex justify-between text-[#747474] font-normal text-sm">
              <p>
                ...
                <span className="text-[#000000]">/</span> Property for Sale in{" "}
                {area}
              </p>
            ...
            <div className="flex justify-between items-end">
              <div className="flex flex-col gap-1">
                ...
                <p className="text-lg font-medium text-[#222222]">
                  Property for Sale in {area}, {city}
                </p>
              </div>
