...
import { CardBody, CardFooter, ThemeButton } from '../../components/common/Components';
    ...
    return (
        <div className='mt-15 bg-linear-to-t from-[#FFEEE0] to-[#FFFFFF] flex flex-col gap-[50px] px-20'>
            ...
            <Tabs
                ...
                <Tab eventKey="Office" title={<><PiKeyBold />  Office</>}>
                    <TabContent />
                </Tab>
                <Tab eventKey="Industrial Area" title={<><RiHomeLine /> Industrial Area</>}>
                    <TabContent />
                </Tab>
            </Tabs>
