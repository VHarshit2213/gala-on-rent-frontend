...
const Home = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      navigate(`/search-property/${values.city}/${values.popularArea}`);
    },
  });
              ...
              {tabs.map((label) => (
                ...
                >
                  <form
                    ...
                    className="flex items-center justify-center text-muted-transparent"
                  >
                    ...
                    <div className="flex gap-4 items-center justify-between py-[30px] w-full">
                      ...
                      <Button
                        className="text-white bg-orange rounded-md text-lg font-normal p-2 px-3 w-full max-w-[114px] cursor-pointer"
                        type="submit"
                      >
                        Search
                      </Button>
