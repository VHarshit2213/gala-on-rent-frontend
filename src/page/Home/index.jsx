...
const Home = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      navigate(
        `/search-property/${values.city}/${values.popularArea}/${tabToPayloadMap[activeTab]}`
      );
    },
  });
    ...
    <>
      <div className="h-[650px]">
        <div className='bg-[url("/assets/home/main-bg.jpg")] bg-cover bg-center h-[550px] w-full relative'>
            <Card cardClassName="bg-white rounded-2xl shadow-[-5px_0px_20px_0px_#00000040] absolute top-1/2 left-1/2 transform -translate-x-1/2 translate-y-[97%] md:max-w-[900px] w-[90%] z-40">
              <Tabs
                defaultActive="Buy"
