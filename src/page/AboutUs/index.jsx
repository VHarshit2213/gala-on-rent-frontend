...
const AboutUs = () => {
    return (
        <div className='flex flex-col'>
            ...
            <div className='bg-linear-to-t from-[#FFEEE0] to-[#FFFFFF] py-6 xsm:py-10 md:py-17.5 px-4 xsm:px-6 sm:px-10 lg:px-15 flex flex-col lg:gap-y-10 sm:gap-y-6 gap-y-3'>
                <p className='xl:text-[64px] lg:text-[55px]  md:text-[40px] sm:text-[30px] text-[20px] font-bold capitalize text-center'>Welcome to <span className='text-orange'>Gala on rent.com</span></p>
